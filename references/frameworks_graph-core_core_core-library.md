---
title: "core-library"
url: "/docs/frameworks/graph-core/core/core-library"
---
...
- 
[State](#state%E7%8A%B6%E6%80%81)：共享的数据结构，表示应用程序的当前快照。它由 `OverAllState` 对象表示。

- 
[Nodes](#%E8%8A%82%E7%82%B9nodes)：一个**函数式接口** (`AsyncNodeAction`)，编码智能体的逻辑。它们接收当前的 `State` 作为输入，执行一些计算或副作用，并返回更新后的 `State`。或者使用 `AsyncNodeActionWithConfig`，它可以额外接收 `RunnableConfig` 用于传递上下文。

- 
[Edges](#%E8%BE%B9edges)：一个**函数式接口** (`AsyncEdgeAction`)，根据当前的 `State` 确定接下来执行哪个 `Node`。它们可以是条件分支或固定转换。或者使用 `AsyncEdgeActionWithConfig`，它可以额外接收 `RunnableConfig` 用于传递上下文。
...
编译图[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/CoreLibraryExample.java)
```java
...
创建 KeyStrategyFactory[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/CoreLibraryExample.java)
```java
...
ReplaceStrategy 示例[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/CoreLibraryExample.java)
```java
...
- **节点 A 执行**：状态中 `value = "初始值"`

- **节点 B 执行**：由于使用 `ReplaceStrategy`，`value` 被替换为 `"更新后的值"`

- **最终状态**：`value = "更新后的值"`（节点 A 的值已被完全覆盖）
...
AppendStrategy 示例[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/CoreLibraryExample.java)
```java
...
- **节点 A 执行**：状态中 `messages = ["消息1"]`

- **节点 B 执行**：由于使用 `AppendStrategy`，`messages` 变为 `["消息1", "消息2"]`

- **节点 C 执行**：继续追加，`messages` 变为 `["消息1", "消息2", "消息3"]`

- **最终状态**：`messages = ["消息1", "消息2", "消息3"]`（所有节点的值都被保留并追加）
...
RemoveByHash 使用示例[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/CoreLibraryExample.java)
```java
...
为自定义数据类增加 Jackson 注解[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/CoreLibraryExample.java)
```java
...
定制 StateGraph 中的默认 Serializer[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/CoreLibraryExample.java)
```java
import com.alibaba.cloud.ai.graph.StateGraph;
...
为 Graph 提供自定义序列化器[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/CoreLibraryExample.java)
```java
...
使用 START 节点[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/CoreLibraryExample.java)
```java
import static com.alibaba.cloud.ai.graph.StateGraph.START;
```
...
添加条件边[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/CoreLibraryExample.java)
```java
import static com.alibaba.cloud.ai.graph.StateGraph.START;
import static com.alibaba.cloud.ai.graph.StateGraph.END;
...
使用会话 ID[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/CoreLibraryExample.java)
```
// 指定会话 ID
