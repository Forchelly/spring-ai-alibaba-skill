---
title: "a2a"
url: "/docs/frameworks/agent-framework/advanced/a2a"
---
...
- （可选）配置 Nacos Registry 进行自动注册

### 定义本地 Agent

定义本地 ReactAgent 示例[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/A2AExample.java)
```java
...
使用 AgentCardProvider 发现并调用远程 Agent[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/A2AExample.java)
```java
...
- **A2A Server AgentCard 自动注册到 Nacos A2A Registry**

- **A2a Client 自动订阅发现可用 AgentCard，实现 AgentCard 调用的负载均衡**
...
A2A 一体化示例：注册 -> 发现 -> 调用[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/A2AExample.java)
```java
import com.alibaba.cloud.ai.graph.agent.ReactAgent;
import com.alibaba.cloud.ai.graph.agent.a2a.A2aRemoteAgent;
import com.alibaba.cloud.ai.graph.agent.a2a.AgentCardProvider;
...
- 打开 Nacos 控制台：[http://localhost:8848/nacos](http://localhost:8848/nacos)

- 登录（nacos/nacos）

- 查看 A2A 服务注册维度，应该能看到注册的 Agent
