...
url: "/docs/frameworks/agent-framework/advanced/context-engineering"
---
...
💬系统提示开发者对LLM的基础指令。💭消息发送给LLM的完整消息列表（对话历史）。🔧工具Agent可以访问以采取行动的工具。🧠模型要调用的实际模型（包括配置）。📋响应格式模型最终响应的架构规范。
...
基于状态的动态提示示例[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/ContextEngineeringExample.java)
```java
...
基于存储的个性化提示示例[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/ContextEngineeringExample.java)
```java
// 从长期记忆加载用户偏好
...
MessageFilterInterceptor 消息过滤示例[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/ContextEngineeringExample.java)
```java
...
> 
> 
> - 上述示例使用 `ModelInterceptor` 来实现临时更新 —— 修改单次调用时发送给模型的消息内容，而不会改变状态中保存的数据。
> 
> - 对于需要持久更新状态的情况（例如生命周期上下文中的摘要示例），请使用如 ModelHook 等生命周期钩子来永久更新对话历史。更多详情请参阅 Hook & Interceptor 文档。
> 
> 
> 
> 
...
ContextualToolInterceptor 基于上下文的工具选择示例[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/ContextEngineeringExample.java)
```java
...
DynamicModelInterceptor 动态模型选择示例[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/ContextEngineeringExample.java)
```java
...
响应格式控制示例[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/ContextEngineeringExample.java)
```java
// 在Agent级别设置输出格式
ReactAgent agent = ReactAgent.builder()
...
StatefulTool 工具中访问状态示例[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/ContextEngineeringExample.java)
```java
...
StateModifyingTool 工具修改状态示例[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/ContextEngineeringExample.java)
```java
...
LoggingHook 自定义Hook示例[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/ContextEngineeringExample.java)
```java
...
SummarizationHook 消息摘要Hook示例[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/ContextEngineeringExample.java)
```java
import com.alibaba.cloud.ai.graph.agent.hook.HookPosition;
