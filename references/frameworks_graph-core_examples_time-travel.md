---
title: "time-travel"
url: "/docs/frameworks/graph-core/examples/time-travel"
---
...
- **性能考虑**: 历史记录会占用内存，生产环境建议使用持久化存储

- **数据一致性**: 确保状态数据可序列化

- **版本兼容**: Graph 结构改变时历史状态可能不兼容

- **清理策略**: 定期清理旧的历史记录

## 相关文档

- [持久化](/docs/frameworks/graph-core/examples/persistence) - 状态持久化

- [等待用户输入](/docs/frameworks/graph-core/examples/human-in-the-loop) - 中断和恢复

- [Checkpoint 机制](/docs/frameworks/graph-core/examples/checkpoint-redis) - 检查点详解
