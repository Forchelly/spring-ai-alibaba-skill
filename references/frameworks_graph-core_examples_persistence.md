---
title: "persistence"
url: "/docs/frameworks/graph-core/examples/persistence"
---
...
- 创建一个 [`Checkpointer`](https://github.com/alibaba/spring-ai-alibaba/blob/main/spring-ai-alibaba-graph-core/src/main/java/com/alibaba/cloud/ai/graph/checkpoint/Checkpoint.java)，例如 [`MemorySaver`](https://github.com/alibaba/spring-ai-alibaba/blob/main/spring-ai-alibaba-graph-core/src/main/java/com/alibaba/cloud/ai/graph/checkpoint/savers/MemorySaver.java)

- 在编译图时通过 [`CompileConfig`](https://github.com/alibaba/spring-ai-alibaba/blob/main/spring-ai-alibaba-graph-core/src/main/java/com/alibaba/cloud/ai/graph/CompileConfig.java) 传递 Checkpointer

- 使用 `threadId` 来标识不同的会话
...
- [等待用户输入](/docs/frameworks/graph-core/examples/human-in-the-loop) - 中断和恢复示例

- [时光旅行](/docs/frameworks/graph-core/examples/time-travel) - 状态历史导航
