---
title: "mcp-node"
url: "/docs/frameworks/graph-core/examples/mcp-node"
---
...
McpNodeProperties[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/McpNodeExample.java)
```java
...
McpGaphConfiguration[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/McpNodeExample.java)
```java
package com.spring.ai.tutorial.graph.mcp.config;
...
McpClientToolCallbackProvider[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/McpNodeExample.java)
```java
...
McpNode[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/McpNodeExample.java)
```java
...
配置 MCP 节点[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/McpNodeExample.java)
```java
import com.alibaba.cloud.ai.graph.OverAllState;
import com.alibaba.cloud.ai.graph.action.NodeAction;
import org.springframework.ai.chat.client.ChatClient;
...
McpController[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/McpNodeExample.java)
```java
...
![](https://java2ai.com/assets/images/NivBbKqXooFsgexeeRrcIV0rnEf-1b3a91952df68336f781d55aa65d11c0.png)
调用接口，触发本地端 MCP Server 提供的时间服务
![](https://java2ai.com/assets/images/LMPkbZ5heoHs2Qx604kcdiplnlc-c1289e5341e5e144b6eb718daae11f4c.png)