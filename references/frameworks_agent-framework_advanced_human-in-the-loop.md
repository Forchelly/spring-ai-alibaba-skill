...
url: "/docs/frameworks/agent-framework/advanced/human-in-the-loop"
---
...
HumanInTheLoopHook 配置示例[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/HumanInTheLoopExample.java)
```java
...
响应中断示例[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/HumanInTheLoopExample.java)
```java
...
HumanInTheLoop 完整示例[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/HumanInTheLoopExample.java)
```java
import com.alibaba.cloud.ai.graph.agent.ReactAgent;
import com.alibaba.cloud.ai.graph.agent.hook.hip.HumanInTheLoopHook;
import com.alibaba.cloud.ai.graph.agent.hook.hip.ToolConfig;
...
- **检查点配置**: 必须在 `CompileConfig` 中注册检查点保存器，以便在工作流级别保存和恢复状态

- **Agent 配置**: 嵌套的 Agent 也需要配置检查点保存器（使用相同的实例）

- **中断处理**: 使用 `CompiledGraph.invokeAndGetOutput()` 检查中断，并使用 `addHumanFeedback()` 恢复执行

Workflow 中嵌套 Agent 的人工中断示例[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/HumanInTheLoopExample.java)
```java
...
HITLHelper 实用工具方法示例[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/HumanInTheLoopExample.java)
```java
...
- [Hooks](/docs/frameworks/agent-framework/tutorials/hooks) - 了解 Hook 机制

- [Interceptors](/docs/frameworks/agent-framework/tutorials/hooks) - 了解 Interceptor 机制

- [Memory](/docs/frameworks/agent-framework/advanced/memory) - 检查点和持久化
