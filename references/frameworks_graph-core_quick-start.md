---
title: "Graph Core"
url: "/docs/frameworks/graph-core/quick-start"
---
...
定义状态和状态键策略[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/QuickStartExample.java)
```java
...
读取和分类节点实现[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/QuickStartExample.java)
```java
import com.alibaba.cloud.ai.graph.action.NodeAction;
import com.alibaba.cloud.ai.graph.OverAllState;
...
搜索和跟踪节点实现[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/QuickStartExample.java)
```java
import com.alibaba.cloud.ai.graph.action.NodeAction;
import com.alibaba.cloud.ai.graph.OverAllState;
import java.util.Map;
...
响应节点实现[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/QuickStartExample.java)
```java
import com.alibaba.cloud.ai.graph.action.NodeAction;
import com.alibaba.cloud.ai.graph.OverAllState;
import org.springframework.ai.chat.client.ChatClient;
...
创建邮件处理 Graph[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/QuickStartExample.java)
```java
...
测试邮件代理[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/QuickStartExample.java)
```java
import com.alibaba.cloud.ai.graph.CompiledGraph;
...
- [等待用户输入](/docs/frameworks/graph-core/examples/human-in-the-loop)

#### 2. 子图

为复杂的多步骤操作创建子图。参考：

- [子图作为 NodeAction](/docs/frameworks/graph-core/examples/subgraph-as-nodeaction)

- [子图作为 StateGraph](/docs/frameworks/graph-core/examples/subgraph-as-stategraph)

- [子图作为 CompiledGraph](/docs/frameworks/graph-core/examples/subgraph-as-compiledgraph)

#### 3. 流式输出

添加流式输出以向用户显示实时进度。参考：

- [LLM 流式输出](/docs/frameworks/graph-core/examples/llm-streaming-springai)
...
- [持久化](/docs/frameworks/graph-core/examples/persistence)

- [时光旅行](/docs/frameworks/graph-core/examples/time-travel)

#### 7. 并行执行

学习如何并行执行多个节点。参考：

- [并行分支](/docs/frameworks/graph-core/examples/parallel-branch)