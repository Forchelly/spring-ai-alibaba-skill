...
url: "/docs/frameworks/graph-core/examples/human-in-the-loop"
---
...
- **InterruptionMetadata 模式**：可以在任意节点随时中断，通过实现 `InterruptableAction` 接口来控制中断时机

- **interruptBefore 模式**：需要提前在编译配置中定义中断点，在指定节点执行前中断
...
定义带中断的 Graph[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/HumanInTheLoopExample.java)
```java
...
实现 InterruptableNodeAction[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/HumanInTheLoopExample.java)
```java
/**
* 可中断的节点动作
...
执行 Graph 直到中断[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/HumanInTheLoopExample.java)
```java
import com.alibaba.cloud.ai.graph.CompiledGraph;
...
等待用户输入并更新状态[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/HumanInTheLoopExample.java)
```java
/**
* 等待用户输入并更新状态
*/
...
继续执行 Graph[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/HumanInTheLoopExample.java)
```java
/**
* 继续执行 Graph
...
定义带中断的 Graph (interruptBefore 模式)[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/HumanInTheLoopExample.java)
```java
import com.alibaba.cloud.ai.graph.CompileConfig;
import com.alibaba.cloud.ai.graph.CompiledGraph;
import com.alibaba.cloud.ai.graph.KeyStrategy;
...
执行 Graph 直到中断 (interruptBefore 模式)[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/HumanInTheLoopExample.java)
```java
import com.alibaba.cloud.ai.graph.CompiledGraph;
import com.alibaba.cloud.ai.graph.RunnableConfig;
...
等待用户输入并更新状态 (interruptBefore 模式)[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/HumanInTheLoopExample.java)
```java
import com.alibaba.cloud.ai.graph.CompiledGraph;
import com.alibaba.cloud.ai.graph.RunnableConfig;
...
继续执行 Graph (interruptBefore 模式)[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/HumanInTheLoopExample.java)
```java
/**
* 继续执行 Graph
*/
...
第二次等待用户输入[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/HumanInTheLoopExample.java)
```java
...
继续执行直到完成[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/HumanInTheLoopExample.java)
```java
// 继续执行 Graph
graph.stream(null, updateConfig)
      .doOnNext(event -> System.out.println(event))
...
ExpanderNode[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/HumanInTheLoopExample.java)
```java
...
TranslateNode[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/HumanInTheLoopExample.java)
```java
package com.spring.ai.tutorial.graph.human.node;
...
边定义[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/HumanInTheLoopExample.java)
```java
...
- [Checkpoint 机制](/docs/frameworks/graph-core/examples/checkpoint-redis) - 状态持久化

- [快速入门](/docs/frameworks/graph-core/quick-start) - Graph 基础使用

- [流式处理](/docs/frameworks/graph-core/examples/llm-streaming-springai) - 流式输出