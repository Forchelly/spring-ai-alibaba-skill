---
title: "subgraph-as-stategraph"
url: "/docs/frameworks/graph-core/examples/subgraph-as-stategraph"
---
...
定义子图[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/SubgraphAsStateGraphExample.java)
```java
...
直接嵌入子图[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/SubgraphAsStateGraphExample.java)
```java
/**
* 在父图中集成子图 - 方式 1: 直接嵌入
*/
...
使用编译后的子图[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/SubgraphAsStateGraphExample.java)
```java
import com.alibaba.cloud.ai.graph.CompiledGraph;
...
共享状态[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/SubgraphAsStateGraphExample.java)
```java
...
状态隔离[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/SubgraphAsStateGraphExample.java)
```java
...
递归子图[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/SubgraphAsStateGraphExample.java)
```java
// Level 2 子图
...
完整示例[查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/SubgraphAsStateGraphExample.java)
```java
...
[子图作为 NodeAction](/docs/frameworks/graph-core/examples/subgraph-as-nodeaction) - 另一种集成方式

- [子图作为 CompiledGraph](/docs/frameworks/graph-core/examples/subgraph-as-compiledgraph) - 编译后使用

- [快速入门](/docs/frameworks/graph-core/quick-start) - Graph 基础